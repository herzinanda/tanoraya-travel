        ...
        <div className="container">
            <div className="section-title-area">
                ...
                <div className="achievement-button wow fadeInUp" data-wow-delay=".7s">
                    <Link href="tour-details.html" className="theme-btn">Read More
                ...
                <div className="row">
                    <div className="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                        <div className="achievement-items">
                            <div className="content">
                                <div className="icon">
                                    <Image src="/img/icon/traveller.svg" alt="img" width={40} height={40} />
                                </div>
                                <h3 className="number">
                    ...
                    <div className="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay=".4s">
                        <div className="achievement-items">
                            <div className="content">
                                <div className="icon">
                                    <Image src="/img/icon/complete.svg" alt="img" width={40} height={40}/>
                                </div>
                    ...
                    <div className="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay=".6s">
                        <div className="achievement-items">
                            <div className="content">
                                <div className="icon">
                                    <Image src="/img/icon/reviews.svg" alt="img" width={40} height={40}/>
                                </div>
                    ...
                    <div className="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay=".8s">
                        <div className="achievement-items">
                            <div className="content">
                                <div className="icon">
                                    <Image src="/img/icon/award.svg" alt="img" width={40} height={40}/>
                                </div>
                                <h3 className="number">
