            ...
            <div className="col-xl-7 col-lg-6">
              <div className="chose-us-image">
                ...
                <div className="chose-us-image3">
                  ...
                  {videoUrl ? (
                    <a href={videoUrl} className="video-btn ripple video-popup" target="_blank" rel="noopener noreferrer">
                ...
                <div className="choose-us-area">
                  {whyChooseUsItem?.map((item, index) => (
                    <React.Fragment key={item.id ?? index}>
                      ...
                      <div className="choose-us-items wow fadeInUp" data-wow-delay={`${(index + 1) * 0.1 + 0.1}s`}>
                        <h3 className="number">{String(index + 1).padStart(2, '0')}</h3>
