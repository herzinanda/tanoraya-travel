            ...
            <div className="swiper destination-slider">
                <div className="swiper-wrapper">
                        ...
                        <div className="destination-card-items">
                            ...
                            <div className="destination-content">
                                ...
                                <div className="booking">
                                    ...
                                    <a href="tour-details.html" className="theme-btn">Read More <Image
                                            src="/img/icon/theme-arrow.svg" alt="img" width={22} height={16} />
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="swiper-slide">
                        <div className="destination-card-items">
                            <div className="destination-thumb">
                                <Image src="/img/destinations/2.jpg" alt="" width={307} height={250}/>
                                <div className="ratting">
                                    <i className="fa-solid fa-star"></i>
                                    <span>4.9</span>
                                </div>
                    ...
                    <div className="swiper-slide">
                        <div className="destination-card-items">
                            <div className="destination-thumb">
                                <Image src="/img/destinations/3.jpg" alt="" width={307} height={250}/>
                                <div className="ratting">
                                    <i className="fa-solid fa-star"></i>
                                    <span>4.9</span>
                                </div>
                    ...
                    <div className="swiper-slide">
                        <div className="destination-card-items">
                            <div className="destination-thumb">
                                <Image src="/img/destinations/4.jpg" alt="" width={307} height={250}/>
                                <div className="ratting">
                                    <i className="fa-solid fa-star"></i>
                                    <span>4.9</span>
                                </div>
